            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <p>
                ...
                using industry-standard SSL/TLS protocols. We implement multiple layers of security to protect your
                information.
              </p>
              <p>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <p>
                In no event shall ORBIT LIVE TEAM, nor its directors, employees, partners, agents, suppliers, or
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <p>
                We strive to maintain 99.9% uptime, but the Service is provided on an "AS IS" and "AS AVAILABLE" basis.
                We do not warrant that the Service will be uninterrupted, timely, secure, or error-free.
              </p>
              <p>
                We reserve the right to withdraw or amend the Service, and any service or material we provide, in our
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <p>
                ...
                ORBIT LIVE TEAM operates, without regard to its conflict of law provisions.
              </p>
              <p>
          ...
          <section className="bg-gradient-to-br from-blue-500/10 to-purple-500/10 border border-blue-500/20 rounded-2xl p-8">
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              ...
              <div className="space-y-2">
                ...
                <p><strong className="text-white">Address:</strong> ORBIT LIVE TEAM Headquarters</p>
              </div>
            </div>
          </section>
      ...
      <div className="max-w-5xl mx-auto px-6 pb-20">
        ...
        >
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <p>
                By accessing and using ORBIT LIVE TEAM ("the Service"), you accept and agree to be bound by
                the terms and provision of this agreement. If you do not agree to abide by the above, please
                do not use this service.
              </p>
              <p>
                These Terms and Conditions constitute a legally binding agreement between you (whether personally
                or on behalf of an entity) and ORBIT LIVE TEAM concerning your access to and use of the platform.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <p>
                ...
                team management purposes. This is the grant of a license, not a transfer of title, and under
              ...
              <p>
                ...
                terminated by ORBIT LIVE TEAM at any time.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <p>
                ...
                recurring and periodic basis (such as monthly or annually), depending on the type of subscription
                plan you select.
              </p>
              <p>
                At the end of each billing cycle, your subscription will automatically renew under the exact same
                conditions unless you cancel it or ORBIT LIVE TEAM cancels it.
              </p>
              <p>
                All fees are exclusive of taxes, levies, or duties imposed by taxing authorities. You are responsible
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              ...
              <p>
                After the trial period, payments are non-refundable except as required by law or as explicitly stated
                in your subscription agreement. We may, at our sole discretion, offer refunds on a case-by-case basis.
              </p>
            </div>
          </section>
