...
export function Header({ onMenuClick }: HeaderProps) {
  ...
  return (
    <motion.header
      initial={{ y: -100 }}
      animate={{ y: 0 }}
      className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 border-b border-white/10 shadow-2xl sticky top-0 z-50 backdrop-blur-lg"
    >
      <div className="flex items-center justify-between h-16 px-4 sm:px-6">
        <div className="flex items-center space-x-3 sm:space-x-4 flex-1">
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            className="p-2 rounded-xl hover:bg-white/20 lg:hidden transition-all backdrop-blur-sm touch-manipulation"
        ...
        <div className="flex items-center space-x-2 sm:space-x-3">
          ...
          <div className="relative">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="flex items-center space-x-2 p-1.5 rounded-xl hover:bg-white/20 transition-all backdrop-blur-sm touch-manipulation"
            ...
            >
              <motion.img
                ...
                alt={user?.name || 'User'}
                className="w-9 h-9 rounded-full border-2 border-white/40 object-cover shadow-lg"
              />
